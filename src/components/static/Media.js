...
const MediaPage = () => (
  <div className="container container-body mt-md-5 pt-md-5 pb-5">
    ...
    <div className="row name-drop pt-2">
      ...
      <div data-aos="fade-in" data-aos-delay="500" data-aos-offset="100" className="col-12 col-md-4 pb-3 pt-5">
        <div className="image">
      ...
      <div data-aos="fade-in" data-aos-delay="600" data-aos-offset="100" className="col-12 col-md-4 pb-3 pt-5">
        <div className="image">
